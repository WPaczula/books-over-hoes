...
const BookStatusBadge = ({ status }: Props) => {
  switch (status) {
    ...
    case 'AWAITING_SENDING': return <span className="bg-purple-100 text-purple-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-purple-900 dark:text-purple-300">AWAITING SENDING</span>
